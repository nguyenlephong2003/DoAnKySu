...
class ChamCongModel {
    ...
    public function updateBangPhanCong($maBangPhanCong, $ngayThamGia, $ngayKetThuc, $soNgayThamGia) {
        try {
            ...
            // Nếu ngayKetThuc là null (từ cả string "null" hoặc null thực sự), bind là NULL
            if ($ngayKetThuc === null) {
                $stmt->bindValue(":ngayKetThuc", null, PDO::PARAM_NULL);
            } else {
                $stmt->bindParam(":ngayKetThuc", $ngayKetThuc);
            }
