...
('BG001', N'Báo giá thi công nhà phố', N'Đã duyệt', 'LBG001'),
('BG002', N'Báo giá vật liệu xây dựng A', N'Chờ duyệt', 'LBG002'),
('BG003', N'Báo giá nhân công công trình B', N'Từ chối', 'LBG003'),
('BG004', N'Báo giá dịch vụ bảo trì năm 2025', N'Đã duyệt', 'LBG004'),
('BG005', N'Báo giá thi công biệt thự', N'Chờ duyệt', 'LBG001');
