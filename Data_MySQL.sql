...
('AD001', 'Nguyễn Văn Admin', '0901234567', '079123456789', 'admin@congty.com', '2020-01-01',350000, 1),
('GD001', 'Trần Thị Giám Đốc', '0912345678', '079234567890', 'giamdoc@congty.com', '2019-01-01',500000, 2),
('KT001', 'Lê Văn Kế Toán', '0923456789', '079345678901', 'ketoan@congty.com', '2020-03-15',320000, 3),
('NS001', 'Phạm Thị Nhân Sự', '0934567890', '079456789012', 'nhansu@congty.com', '2020-05-10',330000, 4),
('QL001', 'Hoàng Quản Lý', '0945678901', '079567890123', 'quanly1@congty.com', '2020-02-20',310000, 5),
('QL002', 'Lý Thị Quản Lý', '0956789012', '079678901234', 'quanly2@congty.com', '2020-06-15',310000, 5),
('TC001', 'Trịnh Văn Thợ', '0967890123', '079789012345', 'thochinh1@congty.com', '2020-07-10',300000, 6),
('TC002', 'Đặng Thợ Chính', '0978901234', '079890123456', 'thochinh2@congty.com', '2020-08-05',300000, 6),
('TP001', 'Ngô Văn Phụ', '0989012345', '079901234567', 'thophu1@congty.com', '2020-09-01',280000, 7),
('TP002', 'Mai Thị Phụ', '0990123456', '079012345678', 'thophu2@congty.com', '2020-10-10',280000, 7),
('K001', 'Phạm Văn Kho', '0901111222', '079222333444', 'kho1@congty.com', '2021-01-15',290000, 8),
('K002', 'Trần Thị Kho', '0902222333', '079333444555', 'kho2@congty.com', '2021-03-20',290000, 8),
('TV001', 'Lê Văn Tư Vấn', '0903333444', '079444555666', 'tuvan1@congty.com', '2021-02-10',270000, 9),
('TV002', 'Nguyễn Thị Tư Vấn', '0904444555', '079555666777', 'tuvan2@congty.com', '2021-04-25',270000, 9);
...
('HD001', '2023-01-15', 'Hợp đồng xây dựng nhà phố 3 tầng', 1500000000, 'HD001', 'GD001'),
('HD002', '2023-02-20', 'Hợp đồng thiết kế và thi công biệt thự', 3500000000, 'HD002', 'GD001'),
('HD003', '2023-03-10', 'Hợp đồng cải tạo căn hộ', 800000000, 'HD003', 'TV001');

INSERT INTO `PhuLuc` (`MaPhuLuc`, `NgayLap`, `FilePhuLuc`, `MaHopDong`) VALUES
...
INSERT INTO ChiTietBaoGia (MaChiTietBaoGia, MaBaoGia, MaCongTrinh, GiaBaoGia,NoiDung)
VALUES 
...
('NCC001', 'Công ty TNHH Vật liệu Xây dựng ABC', '0987654321', 'Quận 12, TP.HCM', 'Vật liệu xây dựng'),
('NCC002', 'Công ty CP Thiết bị Nội thất XYZ', '0976543210', 'Quận Bình Thạnh, TP.HCM', 'Thiết bị nội thất'),
('NCC003', 'Cơ sở Sắt thép Hưng Thịnh', '0965432109', 'Quận 9, TP.HCM', 'Sắt thép xây dựng');
